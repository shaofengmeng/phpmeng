		...
		<div class="w_main content_box">
			<article class="main_wrap clearfix">
				<div class="public_box">
					...
					<form id="frm" action="{{url('Publish/add')}}" method="post">
						{{csrf_field()}}
						<div class="box">
							...
							<div class="cont">
								<div class="row">
									...
									<div>
										...
										{{--<span class="error_tips">● 请选择兼职类型</span>--}}
								...
								<div class="row">
									...
									<div>
										...
										<span class="error_tips">● 请输入5至20字符，不支持特殊标点符号</span>
										<span class="right_tips">输入正确</span>
									</div>
								</div>
								...
								<div class="row">
									...
									<div>
										<label class="ipt_outer"><input maxlength="3" id="resume_num"
											 placeholder="请输入人数" name="per" value=""></label> 人

										<span class="error_tips">● 请输入1至999，仅支持整数</span>
										<span class="right_tips">输入正确</span>
									</div>
								</div>
								...
								<div class="row">
									...
									<div>
										...
										<span class="error_tips">● 请选择结算周期</span>
										<span class="right_tips">输入正确</span>
									</div>
								</div>
								...
								<div class="row" id="salary_row">
									...
									<div>
										...
										<span class="error_tips">● 请输入1至999999，可编辑单位</span>
										<span class="right_tips">输入正确</span>
								...
								<div class="row">
									...
									<div>
										...
										<span class="error_tips">● 请选择工作种类</span>
										<span class="right_tips">输入正确</span>
									</div>
								</div>
                                 <div class="row">
									...
									<div id='standard'>
										...
										<span class="error_tips">● 请选择性别</span>
										<span class="right_tips">输入正确</span>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									...
									<div>
										...
										<span class="error_tips">● 请输入20至2000字符</span>
										<span class="right_tips">输入正确</span>
									</div>
								</div>
							</div>
								...
								<div class="row">
									...
									<div>
										<label class="ipt_outer"><input id="email" name="email" maxlength="50"
											placeholder="请输入联系人的邮箱" value=""></label>
								...
								<div class="row">
									...
									<div>
										<label class="ipt_outer"><input id="host" name="name" maxlength="10"
											placeholder="请输入联系人姓名" value=""></label>

										<span class="error_tips">{{--$errors->first('name')--}}</span>
								...
								<div class="row g-b10">
									...
									<div>
										<label class="ipt_outer"><input id="tel"
											placeholder="请输入接受报名的电话号码"  name="tel" value=""></label>

										<span class="error_tips">{{--$errors->first('tel')--}}</span>
				...
				<div class="box">
					...
					<div class="cont">
						<div class="row">
							...
							<div>
								<select class="select short" id="p" name="p">
								...
								</select> &nbsp; <select class="select short" id="c" name="c">
								...
								</select> &nbsp; <select class="select short" id="a" name="a">
